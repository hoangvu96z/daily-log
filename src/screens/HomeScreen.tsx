      ...
      <View style={styles.heroCard}>
        ...
        {highlights.length > 0 ? (
          ...
          <Text style={styles.heroTitle}>
            {hasEntries
              ? 'Hôm qua chưa có khoảnh khắc nào được lưu.'
              : 'Chào bạn! Hãy bắt đầu ghi lại khoảnh khắc đầu tiên bằng nút + bên dưới.'}
          </Text>
        )}
      </View>
          ...
          <View style={styles.moodCalendarGrid}>
            {days.map((day) => (
              <View key={day.dateKey} style={styles.moodDayCell}>
                ...
                <Text style={styles.moodCellText}>{day.mood ? `${moodEmoji[day.mood]} ${moodLabels[day.mood]}` : 'Trống'}</Text>
