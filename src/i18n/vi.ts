export const vi = {
  ...
  settings: {
    ...
    paywallFeature2Title: 'Nhiều Ảnh Mỗi Khoảnh Khắc',
    paywallFeature2Desc: 'Đính kèm nhiều ảnh và video vào cùng một khoảnh khắc.',
    ...
    paywallFeature5Title: 'Weekly Reel & Lịch Cảm Xúc',
    paywallFeature5Desc: 'Xem lại kỷ niệm dạng reel hàng tuần và lịch mood 30 ngày toàn diện.',
