...
export const en: typeof vi = {
  ...
  settings: {
    ...
    paywallFeature2Title: 'Multiple Photos Per Moment',
    paywallFeature2Desc: 'Attach multiple photos and videos to a single moment.',
    ...
    paywallFeature5Title: 'Weekly Reel & Mood Calendar',
    paywallFeature5Desc: 'Relive memories as weekly reels and view a full 30-day mood calendar.',
